...
class _AddPictogramScreenState extends State<AddPictogramScreen> {
  ...
  try {
    ...
    final String newPath = path.join(directory.path, path.basename(_image!.path));
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Pictograma salvo com sucesso!')),
    );
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Erro ao salvar o pictograma.')),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Adicionar Pictograma')),
      body: Padding(
                ...
                children: [
                  ...
                  if (_image != null)
                    DropdownButton<String>(
                      ...
                      isExpanded: true, // Para ocupar toda a largura disponível
                      items:
